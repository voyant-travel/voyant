...
Publish the generated API clients.
...
`@voyant-travel/public-api-contracts`, so a client can classify a token without
the framework kernel reaching npm. `core` re-exports it and every in-repo
import is unchanged.
