...
"@voyantjs/finance-contracts": minor
"@voyantjs/crm-contracts": minor
"@voyantjs/transactions-contracts": minor
"@voyantjs/suppliers-contracts": minor
"@voyantjs/identity-contracts": minor
"@voyantjs/legal-contracts": minor
---

Add `@voyantjs/schema-kit` and extend the `*-contracts` pattern to the
operational modules.
