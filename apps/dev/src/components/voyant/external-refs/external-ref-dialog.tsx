...
type RefStatus = (typeof EXTERNAL_REF_STATUSES)[number]
...
const formSchema = z.object({
  ...
  isPrimary: z.boolean(),
  status: z.enum(EXTERNAL_REF_STATUSES),
  metadataJson: z
    .string()
    .refine(
      (value) => {
          ...
          <DialogBody className="grid gap-4">
            ...
            <div className="grid grid-cols-2 gap-4">
              <div className="flex flex-col gap-2">
                <Label>Status</Label>
                <Select
                  items={EXTERNAL_REF_STATUSES.map((x) => ({
                    label: x.replace(/_/g, " "),
                    value: x,
                  }))}
                ...
                >
                  ...
                  <SelectContent>
                    {EXTERNAL_REF_STATUSES.map((status) => (
