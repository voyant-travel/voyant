...
export const operationsVoyantModule = defineModule({
  ...
  tools: [
    ...
    {
      id: "@voyant-travel/operations#tool.attach-departure-fleet-resource",
      name: "attach_departure_fleet_resource",
      runtime: {
        entry: "@voyant-travel/operations/tools",
        export: "attachDepartureFleetResourceTool",
      },
      requiredScopes: ["operations:write"],
      context: ["operations"],
      risk: "medium",
    },
    {
      ...
      runtime: {
        entry: "@voyant-travel/operations/tools",
        export: "detachDepartureFleetResourceTool",
      },
      // `operations:write`, not `operations:delete`: the HTTP leg this mirrors
      // carries the same posture as every other departure-planning write, and a
      // Tool that demanded a scope no role grants would simply be unreachable.
      // The destructive posture is carried by the Tool tier and the action's
      // `high` risk and required approval.
      requiredScopes: ["operations:write"],
      context: ["operations"],
      risk: "high",
    },
    {
      ...
      runtime: {
        entry: "@voyant-travel/operations/tools",
        export: "listDepartureFleetResourcesTool",
      },
      requiredScopes: ["operations:read"],
      context: ["operations"],
      risk: "low",
    ...
    {
      id: "@voyant-travel/operations#tool.set-departure-traveler-assignments",
      name: "set_departure_traveler_assignments",
      runtime: {
        entry: "@voyant-travel/operations/tools",
        export: "setDepartureTravelerAssignmentsTool",
      },
      requiredScopes: ["operations:write"],
      context: ["operations"],
      risk: "medium",
    ...
    {
      id: "@voyant-travel/operations#tool.materialize-departure-room-block",
      name: "materialize_departure_room_block",
      runtime: {
        entry: "@voyant-travel/operations/tools",
        export: "materializeDepartureRoomBlockTool",
      },
      requiredScopes: ["operations:write"],
      context: ["operations"],
      risk: "medium",
    ...
    {
      id: "@voyant-travel/operations#tool.release-departure-room-block",
      name: "release_departure_room_block",
      runtime: {
        entry: "@voyant-travel/operations/tools",
        export: "releaseDepartureRoomBlockTool",
      },
      // `operations:write` for the same reason detaching a fleet resource is:
      // the HTTP leg it mirrors carries the departure-planning posture, and a
      // scope no role grants would make the Tool unreachable. The destructive
      // posture rides on the Tool tier and the action's `high` risk.
      requiredScopes: ["operations:write"],
      context: ["operations"],
      risk: "high",
    },
    {
      id: "@voyant-travel/operations#tool.set-departure-traveler-rooming-preferences",
      name: "set_departure_traveler_rooming_preferences",
      runtime: {
        entry: "@voyant-travel/operations/tools",
        export: "setDepartureTravelerRoomingPreferencesTool",
      },
      requiredScopes: ["operations:write"],
      context: ["operations"],
      risk: "medium",
  ...
  actions: [
    ...
    {
      id: "@voyant-travel/operations#action.attach-departure-fleet-resource",
      version: "v1",
      kind: "execute",
      targetType: "departure",
    ...
    {
      id: "@voyant-travel/operations#action.detach-departure-fleet-resource",
      version: "v1",
      kind: "execute",
      targetType: "departure",
      commandTargetField: "departureId",
    ...
    {
      id: "@voyant-travel/operations#action.list-departure-fleet-resources",
      version: "v1",
      kind: "read",
      targetType: "departure",
      requiredScopes: ["operations:read"],
      risk: "low",
      ledger: "optional",
      from: { tools: ["@voyant-travel/operations#tool.list-departure-fleet-resources"] },
    },
    {
      id: "@voyant-travel/operations#action.set-departure-traveler-assignments",
      version: "v1",
      kind: "execute",
      targetType: "departure",
      commandTargetField: "departureId",
    ...
    {
      id: "@voyant-travel/operations#action.materialize-departure-room-block",
      version: "v1",
      kind: "execute",
      targetType: "departure",
      commandTargetField: "departureId",
    ...
    {
      id: "@voyant-travel/operations#action.release-departure-room-block",
      version: "v1",
      kind: "execute",
      targetType: "departure",
      commandTargetField: "departureId",
    ...
    {
      id: "@voyant-travel/operations#action.set-departure-traveler-rooming-preferences",
      version: "v1",
      kind: "execute",
      targetType: "departure",
      commandTargetField: "departureId",
