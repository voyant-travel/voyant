...
import type { bookingPaymentSchedules, invoices, PaymentSession } from "@voyantjs/finance"
...
export interface InitiatedCheckoutCollection {
  ...
  invoiceNotification: import("@voyantjs/notifications").NotificationDelivery | null
  paymentSessionNotification: import("@voyantjs/notifications").NotificationDelivery | null
