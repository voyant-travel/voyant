  ...
  settings: {
    channelsPage: {
      ...
      publication: {
        ...
        supplierOptional: "Infer supplier",
        decisionLabel: "Decision",
        include: "Include",
        exclude: "Exclude",
        reasonLabel: "Reason",
        reasonPlaceholder: "Why this publication decision exists",
        saveProduct: "Save product rule",
        saveSupplier: "Save supplier rule",
        previewSupplier: "Preview impact",
        supplierImpact: "{count} products affected",
        confirmSupplierImpact: "Confirm saving this supplier rule for {count} affected products.",
        previewRequiredCurrent: "Preview the current supplier inputs before saving.",
        productsEmpty: "No product publication rules for this channel.",
        suppliersEmpty: "No supplier publication rules for this channel.",
        noReason: "No reason recorded.",
        editRule: "Edit",
        deleteRule: "Delete",
        whyTitle: "Effective Why",
        whyDescription: "Inspect the effective decision without using product mappings.",
        published: "Published",
        denied: "Denied",
