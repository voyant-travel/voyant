...
export const suppliersUiRo = {
  ...
  supplierDetailPage: {
    ...
    publication: {
      title: "Unde este publicat acest furnizor",
      description:
        "Publicarea decide in ce canale de vanzare sunt indexate produsele acestui furnizor. O regula proprie a unui produs are prioritate fata de ce setezi aici.",
      loading: "Se incarca canalele...",
      loadError: "Nu am putut incarca regulile de publicare. Incearca din nou.",
      noChannels: "Inca nu exista canale de vanzare.",
      states: {
        included: "Publicat",
        excluded: "Ascuns",
        undecided: "Nedecis",
        channelInactive: "Canal inactiv",
      },
      undecidedHint: "Nimic decis — produsele individuale pot fi publicate pe cont propriu.",
      publish: "Publica",
      hide: "Ascunde",
      clear: "Sterge decizia",
      confirm: "Confirma",
      cancel: "Anuleaza",
      impact: "Afecteaza {count} produse.",
      channelsTruncated: "Se afiseaza {shown} din {count} canale.",
      reindexNote: "Modificarea reindexeaza produsele furnizorului pentru acel canal.",
    },
