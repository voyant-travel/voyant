...
export const suppliersUiEn = {
  ...
  supplierDetailPage: {
    ...
    publication: {
      title: "Where this supplier is published",
      description:
        "Publication decides which sales channels this supplier's products are indexed into. A product rule of its own overrides what you set here.",
      loading: "Loading channels...",
      loadError: "Could not load publication rules. Try again.",
      ...
      undecidedHint: "Nothing decided — individual products may still be published on their own.",
      publish: "Publish",
      hide: "Hide",
      clear: "Clear decision",
      confirm: "Confirm",
      cancel: "Cancel",
      impact: "Affects {count} products.",
      channelsTruncated: "Showing {shown} of {count} channels.",
      reindexNote: "Changing this re-indexes the supplier's products for that channel.",
    },
