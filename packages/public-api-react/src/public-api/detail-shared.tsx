import type { ContentResolution } from "@voyant-travel/catalog-react/public-api"
...
import { PublicApiLink, type PublicApiUiMessages, usePublicApiUi } from "./context.js"

type DetailSharedMessages = PublicApiUiMessages["shopDetailShared"]
...
export function BookingSidebar({
  ...
  const t = usePublicApiUi().messages.shopDetailShared
  const priceLabel =
...
export function BackLink(): React.ReactElement {
  ...
  return (
    <p>
      <PublicApiLink href="/shop" to="/shop" className="text-sm underline">
        {t.backToAll}
      </PublicApiLink>
    </p>
  )
