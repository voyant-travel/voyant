...
export type PublicApiConfirmationKind = "card_pending" | "bank_transfer" | "inquiry" | "hold"
...
export function PublicApiConfirmationPage({
  apiUrl,
  bookingId,
  kind = "default",
  paymentRef,
  ...
  apiUrl: string
  bookingId: string
  kind?: PublicApiConfirmationKind | "default"
  paymentRef?: string
}): React.ReactElement {
  return (
...
function BankTransferPanel({
  ...
  const t = usePublicApiMessagesOrDefault().confirmation
