...
export const publicApiMessagesEn = {
  layout: {
...
export type PublicApiMessages = typeof publicApiMessagesEn

export const publicApiMessagesRo: PublicApiMessages = {
  layout: {
...
const publicApiMessageDefinitions = {
  en: publicApiMessagesEn,
  ro: publicApiMessagesRo,
} satisfies LocaleMessageDefinitions<PublicApiMessages>

const publicApiContext = createPackageMessagesContext<PublicApiMessages>("PublicApiMessages")

const defaultPublicApiI18n: PackageI18nValue<PublicApiMessages> = {
  messages: publicApiMessagesEn,
 ...
 * provider.
 */
export function PublicApiMessagesProvider({
  children,
  ...
  return (
    <publicApiContext.ResolvedMessagesProvider
      definitions={publicApiMessageDefinitions}
...
export const usePublicApiMessages = publicApiContext.useMessages

export function usePublicApiMessagesOrDefault(): PublicApiMessages {
  return publicApiContext.useOptionalI18n()?.messages ?? defaultPublicApiI18n.messages
}
