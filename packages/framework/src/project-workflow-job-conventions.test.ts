    ...
    expect(compilation.generatedFiles).toEqual([
      {
        ...
        contents: [
          ...
          '  { id: "project.workflow.booking.a-confirm", definition: workflow0 },',
          '  { id: "project.workflow.z-send-reminder", definition: workflow1 },',
      ...
      },
      {
        ...
        contents: [
          ...
          '  { id: "project.job.a-cleanup", schedule: schedule0, handler: job0 },',
          '  { id: "project.job.z-reconcile", schedule: schedule1, handler: job1 },',
