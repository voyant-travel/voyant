...
components (formerly `@voyant-travel/identity-ui`).
...
(`@voyant-travel/ui`, `@tanstack/react-table`, and other modules' `*-ui` packages)
...
```bash
pnpm add @voyant-travel/identity-react @voyant-travel/ui @tanstack/react-query react react-dom
```
...
```tsx
import { IdentityUiMessagesProvider } from "@voyant-travel/identity-react/ui"
import { identityUiEn } from "@voyant-travel/identity-react/i18n/en"
import { identityUiRo } from "@voyant-travel/identity-react/i18n/ro"
```
