...
- 0dd3000: Record the two generations of the Booking v1 status cutover as equivalent, so
...
- ef14178: Require the rename adoption increment before accepting a quotes → proposals
