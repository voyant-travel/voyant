    ...
    products: {
      ...
      operations: {
        ...
        priceRules: {
          ...
          additionalEmpty:
            "No extra rate plans — the default pricing above is all most products need.",
    ...
    products: {
      ...
      operations: {
        pricingGrid: {
          ...
          advancedHint:
            "Prețuri de cost, anulare, canale de vânzare și planuri tarifare suplimentare.",
          editRoom: "Editează",
          deleteRoom: "Șterge",
        ...
        marketRules: {
          title: "Piete",
          description:
            "Disponibilitate, vizibilitate si vandabilitate per piata, la nivel de produs.",
