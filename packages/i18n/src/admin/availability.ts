    ...
    availability: {
      ...
      details: {
        ...
        resourceTemplates: {
          ...
          description:
            'Define how this option maps to physical resources (rooms, seats, cabins). "Generate resources" on the Allocation tab uses these to materialize the right number of resources per slot.',
          addButton: "Add template",
          editTitle: 'Edit "{kind}" template',
          newTitle: "Add resource template",
          loadFailed: "Could not load templates.",
          emptyMessage:
            'No resource templates yet. Add one so "Generate resources" knows what to create.',
          capacitySummary: "Capacity {capacity} · {pattern}",
  ...
  ro: {
    availability: {
      ...
      details: {
        ...
        resourceTemplates: {
          title: "Sabloane de resurse",
          description:
            'Defineste cum se mapeaza aceasta optiune la resurse fizice (camere, locuri, cabine). "Genereaza resurse" din tab-ul Alocare foloseste aceste sabloane pentru a materializa numarul corect de resurse pe slot.',
          addButton: "Adauga sablon",
          editTitle: 'Editeaza sablonul "{kind}"',
          newTitle: "Adauga sablon de resurse",
          loadFailed: "Sabloanele nu au putut fi incarcate.",
          emptyMessage:
            'Inca nu exista sabloane de resurse. Adauga unul ca "Genereaza resurse" sa stie ce sa creeze.',
          capacitySummary: "Capacitate {capacity} · {pattern}",
