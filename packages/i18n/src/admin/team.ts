...
export const adminTeamMessages = {
  ...
  es: {
    team: {
      title: "Equipo",
      description:
        "Invita a nuevos miembros del personal. El registro público está desactivado: solo pueden unirse las personas invitadas.",
      pendingInvitations: "Invitaciones pendientes",
      noOutstandingInvitations: "No hay invitaciones pendientes.",
      invitationWaitingSingular: "{count} invitación pendiente de aceptar.",
      invitationWaitingPlural: "{count} invitaciones pendientes de aceptar.",
      nothingHereYet: "Todavía no hay nada aquí.",
      revoke: "Revocar",
      revokeConfirm: "¿Revocar la invitación de {email}?",
      expires: "Caduca el {date}",
      history: "Historial",
      historyDescription: "Invitaciones aceptadas o caducadas.",
      redeemed: "Aceptada el {date}",
      expired: "Caducada el {date}",
      inviteMember: "Invitar a un miembro",
      inviteDialogTitle: "Invita a un miembro del equipo",
      inviteDialogDescription:
        "Recibirá un correo con un enlace para establecer una contraseña. El enlace caduca en 72 horas.",
      inviteCreated: "Invitación creada para {email}.",
      inviteEmailSentSuffix: "Se ha enviado un correo.",
      inviteManualShareSuffix:
        "No hay ningún proveedor de correo configurado: comparte el enlace de abajo manualmente.",
      acceptLink: "Enlace de aceptación",
      copied: "Copiado",
      copy: "Copiar",
      done: "Hecho",
      errorCouldNotSendInvitation: "No se ha podido enviar la invitación",
      emailLabel: "Correo electrónico",
      emailPlaceholder: "companero@ejemplo.com",
      cancel: "Cancelar",
      sendInvitation: "Enviar la invitación",
      members: {
        title: "Miembros",
        description: "Personas que pueden acceder a este espacio de trabajo.",
        empty: "Todavía no hay miembros.",
        role: "Rol",
        roleLabel: "Rol",
        fullAccess: "Acceso completo",
        fullAccessHint:
          "Los propietarios y administradores se gestionan en el panel de Voyant Cloud.",
        ...
        permissionsDescription:
          "Elige qué puede hacer este miembro en este espacio de trabajo. Empieza por un preajuste y después ajusta los detalles.",
        roleDefault: "Valor por defecto del rol",
