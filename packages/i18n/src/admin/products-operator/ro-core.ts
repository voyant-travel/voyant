export const operatorAdminProductsMessagesRoCore = {
  ...
  validationSubtypeCode: "Foloseste un cod stabil cu litere mici, de exemplu boat-tour.",
  ...
  productTypeLabel: "Familie produs",
  productTypeNone: "Neclasificat",
  ...
  productTypeSearchPlaceholder: "Cauta familii de produse…",
  productTypeLoading: "Se incarca…",
  productTypeEmpty: "Nu au fost gasite familii de produse.",
  ...
  typeLabel: "Tip",
  // Clasificare de merchandising — familie / subtip / durata, afisate separat
  // de modul de rezervare si modelul de aprovizionare.
  familyLabel: "Familie",
  subtypeLabel: "Subtip",
  durationLabel: "Durata",
  supplyModelLabel: "Model de aprovizionare",
  supplyModelDynamic: "Dinamic",
  supplyModelScheduled: "Programat",
  durationMinutesSuffix: "min",
  durationDaysSuffix: "zile",
  durationUnresolved: "Nesetata",
  durationExplicitHint: "Explicita",
  durationItineraryHint: "Din itinerariu",
  reviewNeededTitle: "Necesita revizuire",
  reviewMissingFamily: "Nicio familie de produs atribuita.",
  reviewUnresolvedDuration: "Durata nu este setata si nu poate fi derivata.",
  reviewClassificationAction: "Revizuieste clasificarea",
  ...
  mediaTitle: "Media",
  seoSharing: {
    title: "SEO si distribuire",
    description:
      "Administreaza metadatele localizate pentru cautare si imaginea afisata la distribuirea produsului.",
    locale: "Limba continutului",
    selectLocale: "Selecteaza o limba",
    newLocale: "Limba noua",
    localePlaceholder: "ro-RO",
    addLocale: "Adauga",
    languageRequired: "Selecteaza o limba inainte de a salva metadatele SEO.",
    seoTitle: "Titlu SEO",
    seoDescription: "Descriere SEO",
    descriptionPlaceholder: "O descriere concisa pentru cautari si linkuri distribuite.",
    effectiveFallback: "Valoare implicita efectiva: {value}",
    saveSeo: "Salveaza SEO",
    clearSeo: "Sterge suprascrierile SEO",
    saveFailed: "Metadatele SEO nu au putut fi salvate.",
    openGraphImage: "Imagine Open Graph",
    imageGuidance:
      "Recomandat: 1200×630 px (aproximativ 1,91:1). Imaginile peste 5 MB se pot incarca lent.",
    selectImage: "Selecteaza o imagine",
    useCoverFallback: "Foloseste coperta produsului ca rezerva",
    saveImage: "Salveaza imaginea de distribuire",
    uploadImage: "Incarca imagine",
    imageOnly: "Elementul Open Graph trebuie sa fie o imagine.",
    imageSaveFailed: "Imaginea Open Graph nu a putut fi salvata.",
    ratioWarning: "Imaginea nu este apropiata de raportul recomandat 1,91:1 si poate fi decupata.",
    widthWarning: "Imaginea are latimea de {width}px; se recomanda cel putin 1200px.",
    fileSizeWarning:
