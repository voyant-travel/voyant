export const operatorAdminProductsMessagesEnCore = {
  ...
  bookingModeDate: "Date only",
  bookingModeDateTime: "Date and time",
  ...
  validationSubtypeCode: "Use a lowercase stable code such as boat-tour.",
  ...
  productTypeLabel: "Product family",
  productTypeNone: "Unclassified",
  ...
  productTypeSearchPlaceholder: "Search product families…",
  productTypeLoading: "Loading…",
  productTypeEmpty: "No product families found.",
  subtypePlaceholder: "boat-tour",
  ...
  typeLabel: "Type",
  // Merchandising classification — family / subtype / duration are shown
  // separately from booking mode and supply model.
  familyLabel: "Family",
  subtypeLabel: "Subtype",
  durationLabel: "Duration",
  supplyModelLabel: "Supply model",
  supplyModelDynamic: "Dynamic",
  supplyModelScheduled: "Scheduled",
  durationMinutesSuffix: "min",
  durationDaysSuffix: "days",
  durationUnresolved: "Not set",
  durationExplicitHint: "Explicit",
  durationItineraryHint: "From itinerary",
  reviewNeededTitle: "Needs review",
  reviewMissingFamily: "No Product family assigned.",
  reviewUnresolvedDuration: "Duration is not set and cannot be derived.",
  reviewClassificationAction: "Review classification",
