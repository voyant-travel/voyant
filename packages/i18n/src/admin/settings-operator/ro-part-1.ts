export const operatorAdminSettingsMessagesRoPart1 = {
  ...
  productTypes: "Familii de produse",
  ...
  paymentsPage: {
    ...
    pendingRequirements: "Actiune necesara",
    pendingVerification: "Verificare in asteptare",
    ...
    startOnboarding: "Configureaza",
    onboardingTitle: "Configureaza {provider}",
    onboardingDescription:
      "Finalizeaza configurarea securizata integrata a procesatorului pentru a activa platile si transferurile.",
    continueOnboarding: "Continua configurarea",
    onboardingUnavailableTitle: "Configurarea integrata nu este instalata",
    onboardingUnavailableDescription:
      "Aceasta instalare trebuie sa ofere clientul aprobat de configurare integrata inainte de a continua.",
    onboardingFailed: "Nu s-a putut porni configurarea platilor.",
    readinessDescription: "Starea platilor si transferurilor pentru acest cont.",
    requirementsTitle: "Cerinte",
    requirementDeadline: "Termen {date}",
    ...
    emptyDescription: "Instaleaza sau activeaza un procesator de plati pentru a-l configura aici.",
