export const operatorAdminSettingsMessagesEnPart1 = {
  ...
  operatorProfilePage: {
    ...
    branding: {
      ...
      description: "Reusable operator branding for documents and every customer-facing surface.",
      brandColorLabel: "Brand color",
      brandColorHexLabel: "Brand color hex value",
      ...
      faviconDescription: "The browser-tab icon used by customer-facing surfaces.",
      faviconHelp: "Upload a square image for the clearest result.",
    ...
    customerExperience: {
      ...
      description:
        "Support, legal links, and languages shared by your portal, booking engine, and websites.",
      supportEmailLabel: "Support email",
      termsUrlLabel: "Terms URL",
      privacyUrlLabel: "Privacy URL",
      supportedLocalesLabel: "Supported customer languages",
      defaultLocaleLabel: "Default customer language",
    },
    paymentCollection: {
  ...
  paymentsPage: {
    ...
    pendingRequirements: "Action required",
    ...
    startOnboarding: "Set up",
    onboardingTitle: "Set up {provider}",
    onboardingDescription:
      "Complete the provider's secure embedded setup to activate payments and payouts.",
    continueOnboarding: "Continue setup",
    onboardingUnavailableTitle: "Embedded setup is not installed",
    onboardingUnavailableDescription:
      "This deployment must provide its approved embedded onboarding client before setup can continue.",
    onboardingFailed: "Could not start payment onboarding.",
    readinessDescription: "Payment and payout readiness for this account.",
    requirementsTitle: "Requirements",
    requirementDeadline: "Due {date}",
    ...
    emptyDescription: "Install or enable a payment provider to configure one here.",
