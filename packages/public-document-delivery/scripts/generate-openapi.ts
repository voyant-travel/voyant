...
import { createPublicDocumentDeliveryRoutes } from "../src/index.js"

const PREFIX = "/v1/public/documents"
const artifactPath = resolve(
  import.meta.dirname,
  "..",
  "openapi/public-api/public-document-delivery.json",
)
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = createPublicDocumentDeliveryRoutes().getOpenAPI31Document({
...
// No `stampModuleMetadata` here: this package does not depend on
