...
import type { SupplierDetailHostSlotContext } from "@voyantjs/suppliers-ui/admin"
import {
  Button,
  Card,
  CardContent,
 ...
 * `@voyantjs/suppliers-ui`, so the supplier host cannot import the
