...
import { inventoryExtrasRoutes } from "../src/extras/routes.js"

const PREFIX = "/v1/admin/extras"
const MODULE = "inventory"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/extras.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = inventoryExtrasRoutes.getOpenAPI31Document({
