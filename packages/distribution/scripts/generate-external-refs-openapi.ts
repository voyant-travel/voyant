...
import { externalRefsRoutes } from "../src/external-refs/routes.js"

const PREFIX = "/v1/admin/external-refs"
const MODULE = "distribution"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/external-refs.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = externalRefsRoutes.getOpenAPI31Document({
