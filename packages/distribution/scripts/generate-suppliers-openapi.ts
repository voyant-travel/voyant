...
import { suppliersAdminRoutes } from "../src/suppliers/routes.js"

const PREFIX = "/v1/admin/suppliers"
const MODULE = "distribution"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/suppliers.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = suppliersAdminRoutes.getOpenAPI31Document({
