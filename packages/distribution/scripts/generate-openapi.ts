...
const PREFIX = "/v1/admin/distribution"
const MODULE = "distribution"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/distribution.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = distributionRoutes.getOpenAPI31Document({
