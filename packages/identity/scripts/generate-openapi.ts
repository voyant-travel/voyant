...
const PREFIX = "/v1/admin/identity"
const MODULE = "identity"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/identity.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = identityRoutes.getOpenAPI31Document({
