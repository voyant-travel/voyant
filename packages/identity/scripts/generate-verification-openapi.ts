...
const PREFIX = "/v1/public/customer-verification"
const MODULE = "identity"
const artifactPath = resolve(
  import.meta.dirname,
  "..",
  "openapi/public-api/identity-verification.json",
)
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = createCustomerVerificationPublicRoutes().getOpenAPI31Document({
