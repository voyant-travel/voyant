...
const PREFIX = "/v1/admin/notifications"
const MODULE = "notifications"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/notifications.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = createNotificationsRoutes().getOpenAPI31Document({
