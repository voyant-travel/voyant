...
export const legalVoyantModule = defineModule({
  ...
  tools: [
    ...[
      ...
      [
        "list-applicable-booking-contract-templates",
        "list_applicable_booking_contract_templates",
      ...
      ["void-contract", "void_legal_contract", "voidLegalContractTool", "legal:write", "critical"],
      [
        "execute-contract",
  ...
  actions: [
    ...
    {
      id: "@voyant-travel/legal#action.inspect-booking-contract-review",
      version: "v1",
      kind: "sensitive-read",
      targetType: "legal-contract",
      resource: "legal",
      ...
      approval: "never",
      allowedActorTypes: ["staff"],
      from: { tools: ["@voyant-travel/legal#tool.get-booking-contract-review"] },
    },
    {
      id: "@voyant-travel/legal#action.create-contract-template",
      version: "v1",
      kind: "execute",
      targetType: "contract-template",
      resource: "legal",
      ...
      from: { tools: ["@voyant-travel/legal#tool.create-contract-template"] },
    },
    {
      id: "@voyant-travel/legal#action.update-contract-template",
      version: "v1",
      kind: "execute",
      targetType: "contract-template",
      ...
      from: { tools: ["@voyant-travel/legal#tool.update-contract-template"] },
    },
    {
