...
export const bookingContractReviewSnapshotSchema = z.object({
  booking: z.object({
    id: z.string(),
    reference: z.string(),
...
export const bookingContractReviewWorkflowSchema = z
  .object({
...
export type BookingContractReviewSnapshot = z.infer<typeof bookingContractReviewSnapshotSchema>
