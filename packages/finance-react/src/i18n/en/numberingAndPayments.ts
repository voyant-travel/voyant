...
export const invoiceNumberSeriesDialog = {
  ...
  help: {
    ...
    default: "Used automatically when no other series is chosen.",
...
export const paymentPolicy = {
  form: {
    ...
    days: {
      ...
      graceDaysLabel: "Minimum notice",
      graceDaysHelp: "The soonest the balance can fall due, even for last-minute departures.",
...
export const taxesPage = {
  ...
  taxClassSectionDescription: "The tax class you assign to products and booking lines.",
  defaultRegimeSectionTitle: "Default tax regime",
  defaultRegimeSectionDescription: "The default VAT rule this tax class uses.",
