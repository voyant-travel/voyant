...
export const operatorProfile = pgTable("operator_profile", {
  ...
  brandColor: text("brand_color").notNull().default("#f26522"),
  cornerRadius: text("corner_radius").notNull().default("0.625rem"),
  headingFont: text("heading_font").notNull().default("inter-tight"),
  bodyFont: text("body_font").notNull().default("inter-tight"),
