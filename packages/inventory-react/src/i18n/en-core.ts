...
export const productsUiCoreEn = {
  ...
  comboboxes: {
    ...
    productType: {
      ...
      empty: "No product families found.",
    },
    facility: {
  ...
  productForm: {
    ...
    placeholders: {
      ...
      productTypeSearch: "Search product families...",
      productSubtype: "boat-tour",
      durationMinutes: "60",
  ...
  productList: {
    ...
    familyUnavailable: "That Product family is not available. Check Product family settings.",
    filters: {
      button: "Filters",
      statusLabel: "Status",
      statusAll: "All statuses",
      typeLabel: "Product family",
      typeAll: "All families",
    ...
    reviewBadge: "Review",
    reviewMissingFamily: "Product family is missing",
    reviewMissingDuration: "Duration is unresolved",
    durationUnset: "—",
    quickStart: {
      title: "Create a product",
      description:
        "Pick a quick start to prefill sensible defaults, or start blank. Every quick start creates the same kind of product — the defaults are just editable starting points.",
      familyHeading: "Family",
      presetHeading: "Start with a {family} format",
      continueFamily: "Continue with {family} only",
      startBlank: "Start blank",
      creating: "Creating…",
      presets: {
        boatTour: { label: "Boat Tour", description: "Tour · 60 min · timed departures" },
        dayTour: { label: "Day Tour", description: "Tour · single-day" },
        multiDayTour: { label: "Multi-day Tour", description: "Tour · day-by-day itinerary" },
        timedActivity: { label: "Timed Activity", description: "Activity · timed slots" },
        attractionAdmission: {
          label: "Attraction Admission",
          description: "Attraction · admission entry",
        },
        transfer: { label: "Transfer", description: "Transportation · point-to-point" },
      },
    },
