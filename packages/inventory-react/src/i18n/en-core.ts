...
export const productsUiCoreEn = {
  ...
  productList: {
    ...
    quickStart: {
      ...
      creating: "Creating…",
      presets: {
        boatTour: { label: "Boat Tour", description: "60 min · timed departures" },
        dayTour: { label: "Day Tour", description: "Single-day itinerary" },
        multiDayTour: { label: "Multi-day Tour", description: "Day-by-day itinerary" },
        timedActivity: { label: "Timed Activity", description: "Timed slots" },
        attractionAdmission: {
          label: "Attraction Admission",
          description: "Admission entry",
        },
        transfer: { label: "Transfer", description: "Point-to-point" },
      },
    },
