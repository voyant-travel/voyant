...
export const productsUiCoreRo = {
  ...
  productList: {
    ...
    quickStart: {
      ...
      creating: "Se creeaza…",
      presets: {
        boatTour: { label: "Tur cu barca", description: "60 min · plecari programate" },
        dayTour: { label: "Tur de o zi", description: "Itinerariu de o zi" },
        multiDayTour: { label: "Tur de mai multe zile", description: "Itinerariu zi cu zi" },
        timedActivity: {
          label: "Activitate programata",
          description: "Sloturi orare",
        },
        attractionAdmission: {
          label: "Bilet de intrare",
          description: "Intrare cu bilet",
        },
        transfer: { label: "Transfer", description: "Punct la punct" },
      },
    },
