...
import { promotionsRoutes } from "../src/promotions/routes.js"

const PREFIX = "/v1/admin/promotions"
const MODULE = "commerce"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/promotions.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = promotionsRoutes.getOpenAPI31Document({
