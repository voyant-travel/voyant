...
const PREFIX = "/v1/public/markets"
const MODULE = "commerce"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/public-api/markets.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = publicMarketsRoutes.getOpenAPI31Document({
