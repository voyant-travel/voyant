...
const PREFIX = "/v1/public/pricing"
const MODULE = "commerce"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/public-api/pricing.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = publicPricingRoutes.getOpenAPI31Document({
