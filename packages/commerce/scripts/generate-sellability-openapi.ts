...
import { sellabilityRoutes } from "../src/sellability/routes.js"

const PREFIX = "/v1/admin/sellability"
const MODULE = "commerce"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/sellability.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = sellabilityRoutes.getOpenAPI31Document({
