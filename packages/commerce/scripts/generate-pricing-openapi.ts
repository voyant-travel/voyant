...
import { pricingRoutes } from "../src/pricing/routes.js"

const PREFIX = "/v1/admin/pricing"
const MODULE = "commerce"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/pricing.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = pricingRoutes.getOpenAPI31Document({
