...
import { marketsRoutes } from "../src/markets/routes.js"

const PREFIX = "/v1/admin/markets"
const MODULE = "commerce"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/markets.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = marketsRoutes.getOpenAPI31Document({
