...
function resolveOptionalNodeDatabase(
  ...
  return resolveNodeDatabase({
    ...
    ...(env.DATABASE_MAX_TOTAL_CONNECTIONS
      ? { DATABASE_MAX_TOTAL_CONNECTIONS: env.DATABASE_MAX_TOTAL_CONNECTIONS }
      : {}),
    ...(env.DATABASE_MAX_TENANT_POOLS
      ? { DATABASE_MAX_TENANT_POOLS: env.DATABASE_MAX_TENANT_POOLS }
      : {}),
    ...(env.DATABASE_TENANT_POOL_IDLE_MS
      ? { DATABASE_TENANT_POOL_IDLE_MS: env.DATABASE_TENANT_POOL_IDLE_MS }
      : {}),
  })
}
