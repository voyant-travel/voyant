...
export interface PublicApiComposerMessages {
  heading: string
  subheading: string
...
export interface PublicApiComposerGateMessages {
  gateTitle: string
  gateBody: string
  gateSignIn: string
  gateBrowse: string
...
export function PublicApiComposerPage({
  apiUrl,
  gateMessages,
  messages,
  signedIn,
  ...
  apiUrl: string
  gateMessages: PublicApiComposerGateMessages
  messages: PublicApiComposerMessages
  signedIn: boolean
}): React.ReactElement {
  if (signedIn) return <PublicApiComposerBlock apiUrl={apiUrl} messages={messages} />
...
export function PublicApiComposerBlock({
  apiUrl,
  messages: t,
}: {
  apiUrl: string
...
function EmptyTimeline({ messages }: { messages: PublicApiComposerMessages }): React.ReactElement {
  return (
...
function apiError(error: unknown, messages: PublicApiComposerMessages): string {
