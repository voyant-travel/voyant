...
CREATE UNIQUE INDEX IF NOT EXISTS "uq_booking_documents_issued_identity" ON "booking_documents" USING btree ("booking_id","type",coalesce("issued_series", ''),"issued_number") WHERE "booking_documents"."issued_number" IS NOT NULL;
