...
import { bookingRoutes } from "../src/routes-admin.js"

const PREFIX = "/v1/admin/bookings"
const MODULE = "bookings"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/bookings.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = bookingRoutes.getOpenAPI31Document({
