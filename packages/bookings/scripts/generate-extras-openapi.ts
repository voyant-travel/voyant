...
import { bookingsExtrasRoutes } from "../src/extras/routes.js"

const PREFIX = "/v1/admin/extras"
const MODULE = "bookings"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/booking-extras.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = bookingsExtrasRoutes.getOpenAPI31Document({
