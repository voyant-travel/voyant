...
const PREFIX = "/v1/admin/booking-requirements"
const MODULE = "bookings"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/booking-requirements.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = bookingRequirementsRoutes.getOpenAPI31Document({
