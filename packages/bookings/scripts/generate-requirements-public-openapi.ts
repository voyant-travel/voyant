...
const PREFIX = "/v1/public/booking-requirements"
const MODULE = "bookings"
const artifactPath = resolve(
  import.meta.dirname,
  "..",
  "openapi/public-api/booking-requirements.json",
)
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = publicBookingRequirementsRoutes.getOpenAPI31Document({
