...
- b218885: Align facilities admin list indexes with the current filter-and-sort query shapes.
- b218885: Align facilities operations list indexes with the current filter-and-sort query shapes.
