...
// dynamic import inside the loaders so the trip-composer data layer
...
/**
 * Semantic destinations the trip-composer admin surfaces navigate to
...
export interface CreateTripComposerAdminExtensionOptions {
...
/**
 * The trip-composer admin contribution (packaged-admin RFC Phase 3,
 ...
 */
export function createTripComposerAdminExtension(
  options: CreateTripComposerAdminExtensionOptions = {},
): AdminExtension {
        ...
        items: [
          {
            ...
            items: [
              {
                id: "trip-composer-list",
                title: allTrips,
                url: basePath,
              },
              {
                id: "trip-composer-new",
                title: newTrip,
                url: `${basePath}/new`,
              },
            ],
    ...
    routes: [
      {
        ...
        // trip-composer data layer (client + response schemas), and a
 ...
 * the required-fetcher client contract the trip-composer query options
