...
React client utilities for `@voyantjs/trip-composer`.
...
```bash
pnpm add @voyantjs/trip-composer-react @voyantjs/trip-composer
```
...
| `./provider` | `VoyantTripComposerProvider` and context helpers |
