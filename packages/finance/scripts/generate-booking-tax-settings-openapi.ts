...
import { createBookingTaxSettingsRoutes } from "../src/booking-tax.js"

const PREFIX = "/v1/admin/finance"
const MODULE = "finance"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/booking-tax-settings.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = createBookingTaxSettingsRoutes().getOpenAPI31Document({
