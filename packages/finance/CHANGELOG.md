...
- 599ffed: Declare the operator-settings runtime port the Finance module's runtime factory
...
- c6b80c3: Settle a self-service booking create under the action it was admitted with.
...
- 52c794d: Add the `finance.self-service-booking-source.runtime` port that gates public
  booking creation.
...
- accb1cf: Declare safety-contract metadata on the three remaining grandfathered
