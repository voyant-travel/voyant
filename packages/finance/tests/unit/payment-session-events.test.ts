...
describe("payment session events", () => {
  ...
  it("builds booking-targeted action ledger input for payment schedule creation", () => {
    const ledgerInput = buildBookingPaymentScheduleCreateActionLedgerInput(
      {
        userId: "user_123",
        callerType: "session",
      },
  ...
  it("builds booking-targeted action ledger input for payment schedule updates", () => {
    const ledgerInput = buildBookingPaymentScheduleUpdateActionLedgerInput(
      {
        userId: "user_123",
        callerType: "session",
      },
  ...
  it("builds booking-targeted action ledger input for payment schedule deletes", () => {
    const ledgerInput = buildBookingPaymentScheduleDeleteActionLedgerInput(
      {
        userId: "user_123",
        callerType: "session",
      },
  ...
  it("builds booking-targeted action ledger input for booking guarantee creation", async () => {
    const ledgerInput = await buildBookingGuaranteeCreateActionLedgerInput(
      {
        userId: "user_123",
        callerType: "session",
      },
  ...
  it("builds booking-targeted action ledger input for booking guarantee updates", () => {
    const ledgerInput = buildBookingGuaranteeUpdateActionLedgerInput(
      {
        userId: "user_123",
        callerType: "session",
      },
  ...
  it("builds booking-targeted action ledger input for booking guarantee deletes", () => {
    const ledgerInput = buildBookingGuaranteeDeleteActionLedgerInput(
      {
        userId: "user_123",
        callerType: "session",
      },
