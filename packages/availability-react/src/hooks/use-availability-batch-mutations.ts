...
export function useAvailabilityRuleBatchMutation() {
  ...
  >("/v1/availability/rules", availabilityRuleRecordSchema, availabilityQueryKeys.rules)
}
...
export function useAvailabilitySlotBatchMutation() {
  ...
  >("/v1/availability/slots", availabilitySlotRecordSchema, availabilityQueryKeys.slots)
}
...
export function useAvailabilityCloseoutBatchMutation() {
  ...
  >("/v1/availability/closeouts", availabilityCloseoutRecordSchema, availabilityQueryKeys.closeouts)
}
