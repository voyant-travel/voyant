...
export const PREFIXES = {
  ...
  product_notes: "prnt",
  bookings: "book",
  booking_customer_access_grants: "bkag",
  booking_customer_access_commands: "bkcm",
  customer_booking_access_claims: "bkcl",
  ...
  stages: "stg",
  proposals: "prps",
  proposal_participants: "prpt",
  proposal_products: "prpd",
  proposal_versions: "prvr",
  proposal_version_lines: "prvl",
  proposal_media: "prmd",
  activities: "act",
  activity_links: "actl",
