...
export const typeIdSchemas = {
  ...
  bookingCustomerAccessGrant: typeIdSchema("booking_customer_access_grants"),
  bookingCustomerAccessCommand: typeIdSchema("booking_customer_access_commands"),
  customerBookingAccessClaim: typeIdSchema("customer_booking_access_claims"),
  bookingInquiry: typeIdSchema("booking_inquiries"),
  ...
  proposal: typeIdSchema("proposals"),
  proposalParticipant: typeIdSchema("proposal_participants"),
  proposalProduct: typeIdSchema("proposal_products"),
  proposalVersion: typeIdSchema("proposal_versions"),
  proposalVersionLine: typeIdSchema("proposal_version_lines"),
  proposalMedia: typeIdSchema("proposal_media"),
  ...
  app: typeIdSchema("apps"),
  appRedirectUri: typeIdSchema("app_redirect_uris"),
  appCredential: typeIdSchema("app_credentials"),
  appRelease: typeIdSchema("app_releases"),
  appReleaseArtifact: typeIdSchema("app_release_artifacts"),
  appReleaseLocalization: typeIdSchema("app_release_localizations"),
  ...
  refundSettlement: typeIdSchema("refund_settlements"),
