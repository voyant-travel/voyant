...
const PREFIX = "/v1/admin/cruises"
const MODULE = "cruises"
const artifactPath = resolve(import.meta.dirname, "..", "openapi/admin/cruises.json")
const artifact = JSON.parse(readFileSync(artifactPath, "utf8"))

const live = cruiseAdminRoutes.getOpenAPI31Document({
