...
export function createConnectCruiseSourceAdapter(
  ...
  let adapter = memoizeCruiseAdapter(createConnectCruiseAdapter(options), extras.memoize)
...
type CatalogSourceAdapter =
  import("@voyant-travel/catalog-contracts/adapter/contract").SourceAdapter
