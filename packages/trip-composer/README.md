...
This package is landing on the trip-composer integration branch. It currently
...
policy. See
`docs/architecture/trip-composer-implementation-plan.md` for the full PR
sequence and remaining slices.

## Install

```bash
pnpm add @voyantjs/trip-composer
```
