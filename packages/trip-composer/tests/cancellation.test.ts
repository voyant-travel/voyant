...
import { tripComposerService } from "../src/service.js"
...
describe("trip composer cancellation", () => {
  it("cancels selected stay and flight placeholders while leaving product intact", async () => {
    ...
    const result = await tripComposerService.cancelComponents(makeFakeDb(state), {
      envelopeId: "trip_123",
