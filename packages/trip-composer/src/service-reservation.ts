// agent-quality: file-size exception -- owner: trip-composer; existing service module stays co-located until a dedicated split preserves behavior and tests.
...
export async function reserveTrip(
  ...
  if (!trip) {
    throw new TripComposerInvariantError(`Trip envelope ${input.envelopeId} was not found`)
  }
