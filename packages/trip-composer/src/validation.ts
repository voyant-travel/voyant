...
export const tripComposerStatusSchema = z.object({
  module: z.literal("trip-composer"),
  status: z.literal("scaffolded"),
})

export type TripComposerStatus = z.infer<typeof tripComposerStatusSchema>

export const tripComposerHealthCheckSchema = tripComposerStatusSchema

export type TripComposerHealthCheck = z.infer<typeof tripComposerHealthCheckSchema>
