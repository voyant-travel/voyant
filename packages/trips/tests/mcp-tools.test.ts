...
import { createTripTool, priceTripTool, type TripsMcpServices } from "../src/mcp-tools.js"
...
function makeRegistry(services?: Partial<TripsMcpServices>) {
