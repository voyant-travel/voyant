...
export interface McpToolRegistry {
  ...
  // biome-ignore lint/suspicious/noExplicitAny: registry is heterogeneous over args -- owner: trips; existing suppression is intentional pending typed cleanup.
...
export function createMcpToolRegistry(options: CreateMcpToolRegistryOptions): McpToolRegistry {
  // biome-ignore lint/suspicious/noExplicitAny: heterogeneous tool args -- owner: trips; existing suppression is intentional pending typed cleanup.
