CREATE TABLE "booking_sessions" (
  ...
  CONSTRAINT "booking_sessions_anonymous_capability" CHECK (("booking_sessions"."actor_kind" = 'anonymous' AND "booking_sessions"."capability_hash" IS NOT NULL) OR ("booking_sessions"."actor_kind" <> 'anonymous' AND "booking_sessions"."capability_hash" IS NULL))
);
