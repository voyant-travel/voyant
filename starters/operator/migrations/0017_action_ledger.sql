...
ALTER TABLE "action_ledger_outbox" ADD CONSTRAINT "action_ledger_outbox_action_id_fk" FOREIGN KEY ("action_id") REFERENCES "public"."action_ledger_entries"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "action_mutation_details" ADD CONSTRAINT "action_mutation_details_action_id_fk" FOREIGN KEY ("action_id") REFERENCES "public"."action_ledger_entries"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "action_sensitive_read_details" ADD CONSTRAINT "action_sensitive_read_details_action_id_fk" FOREIGN KEY ("action_id") REFERENCES "public"."action_ledger_entries"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "action_approvals" ADD CONSTRAINT "action_approvals_requested_action_id_fk" FOREIGN KEY ("requested_action_id") REFERENCES "public"."action_ledger_entries"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "action_ledger_payloads" ADD CONSTRAINT "action_ledger_payloads_action_id_fk" FOREIGN KEY ("action_id") REFERENCES "public"."action_ledger_entries"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
CREATE UNIQUE INDEX "idx_action_ledger_entries_idempotency" ON "action_ledger_entries" USING btree ("idempotency_scope", "action_name", "target_type", "target_id", "idempotency_key") WHERE "action_ledger_entries"."idempotency_key" IS NOT NULL;--> statement-breakpoint
...
CREATE INDEX "idx_action_ledger_payloads_expiry" ON "action_ledger_payloads" USING btree ("expires_at");
