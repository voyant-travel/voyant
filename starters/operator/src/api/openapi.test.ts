...
const PACKAGE_OPENAPI_ROOTS = new Map([
  ...
  ["booking-requirements", join(REPO_ROOT, "packages/bookings/openapi")],
  ["bookings", join(REPO_ROOT, "packages/bookings/openapi")],
  ["catalog-booking", join(REPO_ROOT, "packages/catalog/openapi")],
  ["catalog", join(REPO_ROOT, "packages/catalog/openapi")],
  ["charters", join(REPO_ROOT, "packages/charters/openapi")],
  ["contract-document", join(REPO_ROOT, "packages/legal/openapi")],
  ["cruises", join(REPO_ROOT, "packages/cruises/openapi")],
  ["distribution", join(REPO_ROOT, "packages/distribution/openapi")],
  ["external-refs", join(REPO_ROOT, "packages/distribution/openapi")],
  ["extras", join(REPO_ROOT, "packages/inventory/openapi")],
  ["finance", join(REPO_ROOT, "packages/finance/openapi")],
  ...
  ["legal", join(REPO_ROOT, "packages/legal/openapi")],
  ["markets", join(REPO_ROOT, "packages/commerce/openapi")],
  ...
  ["pricing", join(REPO_ROOT, "packages/commerce/openapi")],
  ["products", join(REPO_ROOT, "packages/inventory/openapi")],
  ["promotions", join(REPO_ROOT, "packages/commerce/openapi")],
  ["quotes", join(REPO_ROOT, "packages/quotes/openapi")],
  ...
  ["sellability", join(REPO_ROOT, "packages/commerce/openapi")],
  ...
  ["trips", join(REPO_ROOT, "packages/trips/openapi")],
