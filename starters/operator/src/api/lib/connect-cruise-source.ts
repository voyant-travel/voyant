 ...
 *
 * The generic `createVoyantConnectSourceAdapter` (@voyant-travel/connect-adapter)
 ...
 * list. The upstream `@voyant-travel/connect-cruises` search projection only ships a
