# @voyant-travel/cruises: static admin routes are shadowed by /:key route

Issue: https://github.com/voyant-travel/voyant/issues/855
Branch: bug/855-voyant-travel-cruises-static-admin-routes-are-shadowed-by-key-rou
State: active
...
- Local workspace: /home/mihai/voyant/voyant/.agent-worktrees/855-voyant-travel-cruises-static-admin-routes-are-shadowed-by-key-rou
- Risk: Low
- Security risk: None
...
**Category:** bug
**Summary:** Fix `@voyant-travel/cruises` admin route ordering so static cruise subresource routes are not captured by the generic `/:key` route.
...
**Verification lane:**
Run `pnpm --filter @voyant-travel/cruises test`, `pnpm --filter @voyant-travel/cruises typecheck`, `pnpm --filter @voyant-travel/cruises-react typecheck`, `pnpm lint:changed`, and `pnpm verify:agent-quality:changed`.
...
- Keep changes on branch `bug/855-voyant-travel-cruises-static-admin-routes-are-shadowed-by-key-rou`.
...
- 2026-05-13 17:45 UTC - Implementation path: reorder `cruiseAdminRoutes` so static subresource routes register before wildcard cruise-key routes, add route-shape regression coverage for `GET /sailings`, and add a patch changeset for `@voyant-travel/cruises`.
...
- 2026-05-13 17:51 UTC - Added a patch changeset for `@voyant-travel/cruises`.
- 2026-05-13 17:55 UTC - Installed workspace dependencies with `pnpm install` because the worktree had no linked `node_modules`.
- 2026-05-13 17:58 UTC - Verification passed: `pnpm --filter @voyant-travel/cruises test`, `pnpm --filter @voyant-travel/cruises typecheck`, `pnpm --filter @voyant-travel/cruises-react typecheck`, `pnpm lint:changed`, `pnpm verify:agent-quality:changed`, and `pnpm verify:fast`.
...
- `pnpm --filter @voyant-travel/cruises test`
- `pnpm --filter @voyant-travel/cruises typecheck`
- `pnpm --filter @voyant-travel/cruises-react typecheck`
- `pnpm lint:changed`
- `pnpm verify:agent-quality:changed`

## Risks And Rollback

- Remove the local worktree with `git worktree remove /home/mihai/voyant/voyant/.agent-worktrees/855-voyant-travel-cruises-static-admin-routes-are-shadowed-by-key-rou` if this
