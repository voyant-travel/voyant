...
CREATE TYPE "public"."hospitality_guarantee_mode" AS ENUM('none', 'card_hold', 'deposit', 'full_prepay', 'on_request');--> statement-breakpoint
CREATE TYPE "public"."hospitality_housekeeping_task_status" AS ENUM('open', 'in_progress', 'completed', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."hospitality_inventory_mode" AS ENUM('pooled', 'serialized', 'virtual');--> statement-breakpoint
CREATE TYPE "public"."hospitality_maintenance_block_status" AS ENUM('open', 'in_progress', 'resolved', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."hospitality_room_block_status" AS ENUM('draft', 'held', 'confirmed', 'released', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."rate_plan_charge_frequency" AS ENUM('per_night', 'per_stay', 'per_person_per_night', 'per_person_per_stay');--> statement-breakpoint
CREATE TYPE "public"."room_unit_status" AS ENUM('active', 'inactive', 'out_of_order', 'archived');--> statement-breakpoint
CREATE TYPE "public"."stay_booking_item_status" AS ENUM('reserved', 'checked_in', 'checked_out', 'cancelled', 'no_show');--> statement-breakpoint
CREATE TYPE "public"."stay_checkpoint_type" AS ENUM('arrival', 'room_assigned', 'check_in', 'room_move', 'charge_posted', 'check_out', 'no_show', 'note');--> statement-breakpoint
CREATE TYPE "public"."stay_folio_status" AS ENUM('open', 'closed', 'transferred', 'void');--> statement-breakpoint
CREATE TYPE "public"."stay_operation_status" AS ENUM('reserved', 'expected_arrival', 'checked_in', 'checked_out', 'no_show', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."stay_service_post_kind" AS ENUM('lodging', 'meal', 'minibar', 'fee', 'adjustment', 'other');--> statement-breakpoint
...
CREATE TYPE "public"."booking_answer_target" AS ENUM('booking', 'traveler', 'extra');--> statement-breakpoint
...
CREATE TYPE "public"."booking_question_target" AS ENUM('booking', 'traveler', 'lead_traveler', 'booker', 'extra', 'service');--> statement-breakpoint
...
CREATE TYPE "public"."contact_requirement_scope" AS ENUM('booking', 'lead_traveler', 'traveler', 'booker');--> statement-breakpoint
...
CREATE TYPE "public"."transaction_contact_assignment_role" AS ENUM('primary_contact', 'other');--> statement-breakpoint
...
CREATE TYPE "public"."transaction_participant_type" AS ENUM('traveler', 'occupant', 'staff', 'other');--> statement-breakpoint
CREATE TYPE "public"."transaction_pii_access_action" AS ENUM('read', 'update', 'delete');--> statement-breakpoint
CREATE TYPE "public"."transaction_pii_access_outcome" AS ENUM('allowed', 'denied');--> statement-breakpoint
CREATE TYPE "public"."transaction_staff_assignment_role" AS ENUM('service_assignee', 'other');--> statement-breakpoint
...
CREATE TYPE "public"."ground_assignment_source" AS ENUM('manual', 'suggested', 'auto');--> statement-breakpoint
CREATE TYPE "public"."ground_checkpoint_status" AS ENUM('pending', 'reached', 'missed', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."ground_dispatch_leg_type" AS ENUM('pickup', 'stop', 'dropoff', 'deadhead');--> statement-breakpoint
CREATE TYPE "public"."ground_dispatch_status" AS ENUM('draft', 'scheduled', 'assigned', 'en_route', 'arrived', 'picked_up', 'completed', 'cancelled', 'no_show');--> statement-breakpoint
CREATE TYPE "public"."ground_driver_shift_status" AS ENUM('scheduled', 'available', 'on_duty', 'completed', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."ground_execution_event_type" AS ENUM('scheduled', 'assigned', 'driver_en_route', 'driver_arrived', 'pickup_completed', 'dropoff_completed', 'cancelled', 'issue', 'note');--> statement-breakpoint
CREATE TYPE "public"."ground_incident_resolution_status" AS ENUM('open', 'mitigated', 'resolved', 'cancelled');--> statement-breakpoint
CREATE TYPE "public"."ground_incident_severity" AS ENUM('info', 'warning', 'critical');--> statement-breakpoint
CREATE TYPE "public"."ground_service_level" AS ENUM('private', 'shared', 'vip', 'shuttle', 'other');--> statement-breakpoint
CREATE TYPE "public"."ground_vehicle_category" AS ENUM('car', 'sedan', 'suv', 'van', 'minibus', 'bus', 'boat', 'train', 'other');--> statement-breakpoint
CREATE TYPE "public"."ground_vehicle_class" AS ENUM('economy', 'standard', 'premium', 'luxury', 'accessible', 'other');--> statement-breakpoint
...
CREATE TYPE "public"."booking_group_kind" AS ENUM('shared_room', 'cruise_party', 'other');--> statement-breakpoint
CREATE TYPE "public"."booking_group_member_role" AS ENUM('primary', 'shared');--> statement-breakpoint
CREATE TYPE "public"."booking_activity_type" AS ENUM('booking_created', 'booking_reserved', 'booking_converted', 'booking_confirmed', 'booking_started', 'booking_completed', 'hold_extended', 'hold_expired', 'status_change', 'status_overridden', 'item_update', 'allocation_released', 'fulfillment_issued', 'fulfillment_updated', 'redemption_recorded', 'supplier_update', 'passenger_update', 'note_added', 'system_action');--> statement-breakpoint
...
CREATE TYPE "public"."booking_item_participant_role" AS ENUM('traveler', 'occupant', 'beneficiary', 'other');--> statement-breakpoint
...
CREATE TYPE "public"."booking_participant_type" AS ENUM('traveler', 'occupant', 'other');--> statement-breakpoint
CREATE TYPE "public"."booking_pii_access_action" AS ENUM('read', 'update', 'delete');--> statement-breakpoint
CREATE TYPE "public"."booking_pii_access_outcome" AS ENUM('allowed', 'denied');--> statement-breakpoint
...
CREATE TYPE "public"."booking_staff_assignment_role" AS ENUM('service_assignee', 'other');--> statement-breakpoint
CREATE TYPE "public"."booking_status" AS ENUM('draft', 'on_hold', 'awaiting_payment', 'confirmed', 'in_progress', 'completed', 'expired', 'cancelled');--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "hospitality_sourced_content" (
	"entity_id" text NOT NULL,
...
CREATE TABLE "housekeeping_tasks" (
	...
	"status" "hospitality_housekeeping_task_status" DEFAULT 'open' NOT NULL,
...
CREATE TABLE "maintenance_blocks" (
	...
	"status" "hospitality_maintenance_block_status" DEFAULT 'open' NOT NULL,
	"reason" text,
	"notes" text,
	"metadata" jsonb,
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
...
CREATE TABLE "room_blocks" (
	...
	"starts_on" date NOT NULL,
	"ends_on" date NOT NULL,
	"status" "hospitality_room_block_status" DEFAULT 'draft' NOT NULL,
	"block_reason" text,
	"quantity" integer DEFAULT 1 NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "room_unit_status_events" (
	"id" text PRIMARY KEY NOT NULL,
	"room_unit_id" text NOT NULL,
...
CREATE TABLE "rate_plans" (
	...
	"guarantee_mode" "hospitality_guarantee_mode" DEFAULT 'none' NOT NULL,
...
CREATE TABLE "room_types" (
	...
	"name" text NOT NULL,
	"description" text,
	"inventory_mode" "hospitality_inventory_mode" DEFAULT 'pooled' NOT NULL,
	"room_class" text,
	"max_adults" integer,
...
--> statement-breakpoint
CREATE TABLE "stay_checkpoints" (
	"id" text PRIMARY KEY NOT NULL,
	"stay_operation_id" text NOT NULL,
	"checkpoint_type" "stay_checkpoint_type" DEFAULT 'note' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "stay_folio_lines" (
	"id" text PRIMARY KEY NOT NULL,
	"stay_folio_id" text NOT NULL,
	"service_post_id" text,
...
--> statement-breakpoint
CREATE TABLE "stay_folios" (
	"id" text PRIMARY KEY NOT NULL,
	"stay_operation_id" text NOT NULL,
	"currency_code" text NOT NULL,
	"status" "stay_folio_status" DEFAULT 'open' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "stay_operations" (
	"id" text PRIMARY KEY NOT NULL,
	"stay_booking_item_id" text NOT NULL,
	"property_id" text NOT NULL,
	"room_unit_id" text,
	"operation_status" "stay_operation_status" DEFAULT 'reserved' NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "stay_service_posts" (
	"id" text PRIMARY KEY NOT NULL,
	"stay_operation_id" text NOT NULL,
	"booking_item_id" text,
	"service_date" date NOT NULL,
	"kind" "stay_service_post_kind" DEFAULT 'other' NOT NULL,
	"description" text NOT NULL,
	"quantity" integer DEFAULT 1 NOT NULL,
	"currency_code" text NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "rate_plan_inventory_overrides" (
	"id" text PRIMARY KEY NOT NULL,
	"rate_plan_id" text NOT NULL,
	"room_type_id" text NOT NULL,
	"date" date NOT NULL,
...
CREATE TABLE "room_inventory" (
	...
	"out_of_order_units" integer DEFAULT 0 NOT NULL,
...
CREATE TABLE "stay_rules" (
	...
	"closed_to_arrival" boolean DEFAULT false NOT NULL,
	"closed_to_departure" boolean DEFAULT false NOT NULL,
	"arrival_weekdays" jsonb,
	"departure_weekdays" jsonb,
...
--> statement-breakpoint
CREATE TABLE "transaction_pii_access_log" (
	"id" text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "offer_contact_assignments" (
	"id" text PRIMARY KEY NOT NULL,
	"offer_id" text NOT NULL,
	"offer_item_id" text,
	"person_id" text,
	"role" "transaction_contact_assignment_role" DEFAULT 'primary_contact' NOT NULL,
	"first_name" text NOT NULL,
	"last_name" text NOT NULL,
	"email" text,
	"phone" text,
...
--> statement-breakpoint
CREATE TABLE "order_contact_assignments" (
	"id" text PRIMARY KEY NOT NULL,
...
CREATE TABLE "offer_items" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "ck_offer_items_cost_currency_amounts" CHECK (("offer_items"."unit_cost_amount_cents" IS NULL AND "offer_items"."total_cost_amount_cents" IS NULL) OR "offer_items"."cost_currency" IS NOT NULL)
);
--> statement-breakpoint
...
CREATE TABLE "order_items" (
	...
	"created_at" timestamp with time zone DEFAULT now() NOT NULL,
	"updated_at" timestamp with time zone DEFAULT now() NOT NULL,
	CONSTRAINT "ck_order_items_cost_currency_amounts" CHECK (("order_items"."unit_cost_amount_cents" IS NULL AND "order_items"."total_cost_amount_cents" IS NULL) OR "order_items"."cost_currency" IS NOT NULL)
);
--> statement-breakpoint
...
--> statement-breakpoint
CREATE TABLE "offer_staff_assignments" (
	"id" text PRIMARY KEY NOT NULL,
	"offer_id" text NOT NULL,
	"offer_item_id" text,
	"person_id" text,
	"role" "transaction_staff_assignment_role" DEFAULT 'service_assignee' NOT NULL,
	"first_name" text NOT NULL,
	"last_name" text NOT NULL,
	"email" text,
	"phone" text,
...
ALTER TABLE "housekeeping_tasks" ADD CONSTRAINT "housekeeping_tasks_room_unit_id_room_units_id_fk" FOREIGN KEY ("room_unit_id") REFERENCES "public"."room_units"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "housekeeping_tasks" ADD CONSTRAINT "housekeeping_tasks_stay_booking_item_id_stay_booking_items_id_fk" FOREIGN KEY ("stay_booking_item_id") REFERENCES "public"."stay_booking_items"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "maintenance_blocks" ADD CONSTRAINT "maintenance_blocks_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "maintenance_blocks" ADD CONSTRAINT "maintenance_blocks_room_type_id_room_types_id_fk" FOREIGN KEY ("room_type_id") REFERENCES "public"."room_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "maintenance_blocks" ADD CONSTRAINT "maintenance_blocks_room_unit_id_room_units_id_fk" FOREIGN KEY ("room_unit_id") REFERENCES "public"."room_units"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "room_blocks" ADD CONSTRAINT "room_blocks_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "room_blocks" ADD CONSTRAINT "room_blocks_room_type_id_room_types_id_fk" FOREIGN KEY ("room_type_id") REFERENCES "public"."room_types"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "room_blocks" ADD CONSTRAINT "room_blocks_room_unit_id_room_units_id_fk" FOREIGN KEY ("room_unit_id") REFERENCES "public"."room_units"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "room_unit_status_events" ADD CONSTRAINT "room_unit_status_events_room_unit_id_room_units_id_fk" FOREIGN KEY ("room_unit_id") REFERENCES "public"."room_units"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "stay_booking_items" ADD CONSTRAINT "stay_booking_items_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "stay_booking_items" ADD CONSTRAINT "stay_booking_items_room_unit_id_room_units_id_fk" FOREIGN KEY ("room_unit_id") REFERENCES "public"."room_units"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "meal_plans" ADD CONSTRAINT "meal_plans_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "room_units" ADD CONSTRAINT "room_units_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "stay_checkpoints" ADD CONSTRAINT "stay_checkpoints_stay_operation_id_stay_operations_id_fk" FOREIGN KEY ("stay_operation_id") REFERENCES "public"."stay_operations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_checkpoints" ADD CONSTRAINT "stay_checkpoints_room_unit_id_room_units_id_fk" FOREIGN KEY ("room_unit_id") REFERENCES "public"."room_units"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_folio_lines" ADD CONSTRAINT "stay_folio_lines_stay_folio_id_stay_folios_id_fk" FOREIGN KEY ("stay_folio_id") REFERENCES "public"."stay_folios"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_folio_lines" ADD CONSTRAINT "stay_folio_lines_service_post_id_stay_service_posts_id_fk" FOREIGN KEY ("service_post_id") REFERENCES "public"."stay_service_posts"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_folios" ADD CONSTRAINT "stay_folios_stay_operation_id_stay_operations_id_fk" FOREIGN KEY ("stay_operation_id") REFERENCES "public"."stay_operations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_operations" ADD CONSTRAINT "stay_operations_stay_booking_item_id_stay_booking_items_id_fk" FOREIGN KEY ("stay_booking_item_id") REFERENCES "public"."stay_booking_items"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_operations" ADD CONSTRAINT "stay_operations_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_operations" ADD CONSTRAINT "stay_operations_room_unit_id_room_units_id_fk" FOREIGN KEY ("room_unit_id") REFERENCES "public"."room_units"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_service_posts" ADD CONSTRAINT "stay_service_posts_stay_operation_id_stay_operations_id_fk" FOREIGN KEY ("stay_operation_id") REFERENCES "public"."stay_operations"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_service_posts" ADD CONSTRAINT "stay_service_posts_booking_item_id_booking_items_id_fk" FOREIGN KEY ("booking_item_id") REFERENCES "public"."booking_items"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "rate_plan_inventory_overrides" ADD CONSTRAINT "rate_plan_inventory_overrides_rate_plan_id_rate_plans_id_fk" FOREIGN KEY ("rate_plan_id") REFERENCES "public"."rate_plans"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "rate_plan_inventory_overrides" ADD CONSTRAINT "rate_plan_inventory_overrides_room_type_id_room_types_id_fk" FOREIGN KEY ("room_type_id") REFERENCES "public"."room_types"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "room_inventory" ADD CONSTRAINT "room_inventory_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "room_inventory" ADD CONSTRAINT "room_inventory_room_type_id_room_types_id_fk" FOREIGN KEY ("room_type_id") REFERENCES "public"."room_types"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "stay_rules" ADD CONSTRAINT "stay_rules_property_id_properties_id_fk" FOREIGN KEY ("property_id") REFERENCES "public"."properties"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_rules" ADD CONSTRAINT "stay_rules_rate_plan_id_rate_plans_id_fk" FOREIGN KEY ("rate_plan_id") REFERENCES "public"."rate_plans"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "stay_rules" ADD CONSTRAINT "stay_rules_room_type_id_room_types_id_fk" FOREIGN KEY ("room_type_id") REFERENCES "public"."room_types"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "offer_contact_assignments" ADD CONSTRAINT "offer_contact_assignments_offer_id_offers_id_fk" FOREIGN KEY ("offer_id") REFERENCES "public"."offers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "offer_contact_assignments" ADD CONSTRAINT "offer_contact_assignments_offer_item_id_offer_items_id_fk" FOREIGN KEY ("offer_item_id") REFERENCES "public"."offer_items"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "order_contact_assignments" ADD CONSTRAINT "order_contact_assignments_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "order_contact_assignments" ADD CONSTRAINT "order_contact_assignments_order_item_id_order_items_id_fk" FOREIGN KEY ("order_item_id") REFERENCES "public"."order_items"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "offer_item_participants" ADD CONSTRAINT "offer_item_participants_traveler_id_offer_participants_id_fk" FOREIGN KEY ("traveler_id") REFERENCES "public"."offer_participants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "order_item_participants" ADD CONSTRAINT "order_item_participants_traveler_id_order_participants_id_fk" FOREIGN KEY ("traveler_id") REFERENCES "public"."order_participants"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "offer_staff_assignments" ADD CONSTRAINT "offer_staff_assignments_offer_id_offers_id_fk" FOREIGN KEY ("offer_id") REFERENCES "public"."offers"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "offer_staff_assignments" ADD CONSTRAINT "offer_staff_assignments_offer_item_id_offer_items_id_fk" FOREIGN KEY ("offer_item_id") REFERENCES "public"."offer_items"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "order_staff_assignments" ADD CONSTRAINT "order_staff_assignments_order_id_orders_id_fk" FOREIGN KEY ("order_id") REFERENCES "public"."orders"("id") ON DELETE cascade ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "order_staff_assignments" ADD CONSTRAINT "order_staff_assignments_order_item_id_order_items_id_fk" FOREIGN KEY ("order_item_id") REFERENCES "public"."order_items"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ground_transfer_preferences" ADD CONSTRAINT "ground_transfer_preferences_pickup_facility_id_facilities_id_fk" FOREIGN KEY ("pickup_facility_id") REFERENCES "public"."facilities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
ALTER TABLE "ground_transfer_preferences" ADD CONSTRAINT "ground_transfer_preferences_dropoff_facility_id_facilities_id_fk" FOREIGN KEY ("dropoff_facility_id") REFERENCES "public"."facilities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ground_dispatch_checkpoints" ADD CONSTRAINT "ground_dispatch_checkpoints_facility_id_facilities_id_fk" FOREIGN KEY ("facility_id") REFERENCES "public"."facilities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ground_dispatch_legs" ADD CONSTRAINT "ground_dispatch_legs_facility_id_facilities_id_fk" FOREIGN KEY ("facility_id") REFERENCES "public"."facilities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ground_driver_shifts" ADD CONSTRAINT "ground_driver_shifts_facility_id_facilities_id_fk" FOREIGN KEY ("facility_id") REFERENCES "public"."facilities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ground_execution_events" ADD CONSTRAINT "ground_execution_events_facility_id_facilities_id_fk" FOREIGN KEY ("facility_id") REFERENCES "public"."facilities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
ALTER TABLE "ground_operators" ADD CONSTRAINT "ground_operators_facility_id_facilities_id_fk" FOREIGN KEY ("facility_id") REFERENCES "public"."facilities"("id") ON DELETE set null ON UPDATE no action;--> statement-breakpoint
...
CREATE INDEX "idx_custom_field_values_entity_type_updated" ON "custom_field_values" USING btree ("entity_type","updated_at");--> statement-breakpoint
CREATE INDEX "idx_custom_field_values_entity_updated" ON "custom_field_values" USING btree ("entity_type","entity_id","updated_at");--> statement-breakpoint
CREATE INDEX "idx_custom_field_values_definition_updated" ON "custom_field_values" USING btree ("definition_id","updated_at");--> statement-breakpoint
...
CREATE INDEX "idx_opportunities_person_updated" ON "opportunities" USING btree ("person_id","updated_at");--> statement-breakpoint
CREATE INDEX "idx_opportunities_org_updated" ON "opportunities" USING btree ("organization_id","updated_at");--> statement-breakpoint
CREATE INDEX "idx_opportunities_pipeline_updated" ON "opportunities" USING btree ("pipeline_id","updated_at");--> statement-breakpoint
CREATE INDEX "idx_opportunities_stage_updated" ON "opportunities" USING btree ("stage_id","updated_at");--> statement-breakpoint
CREATE INDEX "idx_opportunities_owner_updated" ON "opportunities" USING btree ("owner_id","updated_at");--> statement-breakpoint
CREATE INDEX "idx_opportunities_status_updated" ON "opportunities" USING btree ("status","updated_at");--> statement-breakpoint
...
CREATE INDEX "idx_opportunity_participants_opportunity_primary" ON "opportunity_participants" USING btree ("opportunity_id","is_primary","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_opportunity_products_opportunity_created" ON "opportunity_products" USING btree ("opportunity_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_quote_lines_quote_created" ON "quote_lines" USING btree ("quote_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_quotes_opportunity_updated" ON "quotes" USING btree ("opportunity_id","updated_at");--> statement-breakpoint
...
CREATE INDEX "hospitality_sourced_content_locale_fresh_idx" ON "hospitality_sourced_content" USING btree ("locale","fresh_until");--> statement-breakpoint
CREATE INDEX "hospitality_sourced_content_returned_locale_idx" ON "hospitality_sourced_content" USING btree ("entity_id","returned_locale");--> statement-breakpoint
CREATE INDEX "hospitality_sourced_content_schema_version_idx" ON "hospitality_sourced_content" USING btree ("content_schema_version");--> statement-breakpoint
CREATE INDEX "idx_housekeeping_tasks_priority_due_at" ON "housekeeping_tasks" USING btree ("priority","due_at");--> statement-breakpoint
CREATE INDEX "idx_housekeeping_tasks_property_priority_due_at" ON "housekeeping_tasks" USING btree ("property_id","priority","due_at");--> statement-breakpoint
CREATE INDEX "idx_housekeeping_tasks_room_unit_priority_due_at" ON "housekeeping_tasks" USING btree ("room_unit_id","priority","due_at");--> statement-breakpoint
CREATE INDEX "idx_housekeeping_tasks_stay_booking_item_priority_due_at" ON "housekeeping_tasks" USING btree ("stay_booking_item_id","priority","due_at");--> statement-breakpoint
CREATE INDEX "idx_housekeeping_tasks_status_priority_due_at" ON "housekeeping_tasks" USING btree ("status","priority","due_at");--> statement-breakpoint
CREATE INDEX "idx_housekeeping_tasks_task_type_priority_due_at" ON "housekeeping_tasks" USING btree ("task_type","priority","due_at");--> statement-breakpoint
CREATE INDEX "idx_maintenance_blocks_property_starts_on" ON "maintenance_blocks" USING btree ("property_id","starts_on");--> statement-breakpoint
CREATE INDEX "idx_maintenance_blocks_room_type_starts_on" ON "maintenance_blocks" USING btree ("room_type_id","starts_on");--> statement-breakpoint
CREATE INDEX "idx_maintenance_blocks_room_unit_starts_on" ON "maintenance_blocks" USING btree ("room_unit_id","starts_on");--> statement-breakpoint
CREATE INDEX "idx_maintenance_blocks_status_starts_on" ON "maintenance_blocks" USING btree ("status","starts_on");--> statement-breakpoint
CREATE INDEX "idx_maintenance_blocks_dates" ON "maintenance_blocks" USING btree ("starts_on","ends_on");--> statement-breakpoint
CREATE INDEX "idx_room_blocks_property_starts_on" ON "room_blocks" USING btree ("property_id","starts_on");--> statement-breakpoint
CREATE INDEX "idx_room_blocks_room_type_starts_on" ON "room_blocks" USING btree ("room_type_id","starts_on");--> statement-breakpoint
CREATE INDEX "idx_room_blocks_room_unit_starts_on" ON "room_blocks" USING btree ("room_unit_id","starts_on");--> statement-breakpoint
CREATE INDEX "idx_room_blocks_status_starts_on" ON "room_blocks" USING btree ("status","starts_on");--> statement-breakpoint
CREATE INDEX "idx_room_blocks_dates" ON "room_blocks" USING btree ("starts_on","ends_on");--> statement-breakpoint
CREATE INDEX "idx_room_unit_status_events_effective_from" ON "room_unit_status_events" USING btree ("effective_from");--> statement-breakpoint
CREATE INDEX "idx_room_unit_status_events_room_unit_effective_from" ON "room_unit_status_events" USING btree ("room_unit_id","effective_from");--> statement-breakpoint
CREATE INDEX "idx_room_unit_status_events_status_effective_from" ON "room_unit_status_events" USING btree ("status_code","effective_from");--> statement-breakpoint
...
CREATE INDEX "idx_stay_booking_items_room_unit_check_in" ON "stay_booking_items" USING btree ("room_unit_id","check_in_date");--> statement-breakpoint
...
CREATE INDEX "idx_room_units_property_room_number_code" ON "room_units" USING btree ("property_id","room_number","code");--> statement-breakpoint
CREATE INDEX "idx_room_units_room_type_room_number_code" ON "room_units" USING btree ("room_type_id","room_number","code");--> statement-breakpoint
CREATE INDEX "idx_room_units_status_room_number_code" ON "room_units" USING btree ("status","room_number","code");--> statement-breakpoint
CREATE UNIQUE INDEX "uidx_room_units_property_code" ON "room_units" USING btree ("property_id","code");--> statement-breakpoint
CREATE INDEX "idx_stay_checkpoints_operation_occurred_at" ON "stay_checkpoints" USING btree ("stay_operation_id","occurred_at");--> statement-breakpoint
CREATE INDEX "idx_stay_checkpoints_type_occurred_at" ON "stay_checkpoints" USING btree ("checkpoint_type","occurred_at");--> statement-breakpoint
CREATE INDEX "idx_stay_folio_lines_folio_posted_at" ON "stay_folio_lines" USING btree ("stay_folio_id","posted_at");--> statement-breakpoint
CREATE INDEX "idx_stay_folio_lines_service_post_posted_at" ON "stay_folio_lines" USING btree ("service_post_id","posted_at");--> statement-breakpoint
CREATE INDEX "idx_stay_folios_operation_opened_at" ON "stay_folios" USING btree ("stay_operation_id","opened_at");--> statement-breakpoint
CREATE INDEX "idx_stay_folios_status_opened_at" ON "stay_folios" USING btree ("status","opened_at");--> statement-breakpoint
CREATE UNIQUE INDEX "uidx_stay_operations_stay_booking_item" ON "stay_operations" USING btree ("stay_booking_item_id");--> statement-breakpoint
CREATE INDEX "idx_stay_operations_property_created" ON "stay_operations" USING btree ("property_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_stay_operations_room_unit_created" ON "stay_operations" USING btree ("room_unit_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_stay_operations_status_created" ON "stay_operations" USING btree ("operation_status","created_at");--> statement-breakpoint
CREATE INDEX "idx_stay_service_posts_operation_service_date" ON "stay_service_posts" USING btree ("stay_operation_id","service_date");--> statement-breakpoint
CREATE INDEX "idx_stay_service_posts_booking_item_service_date" ON "stay_service_posts" USING btree ("booking_item_id","service_date");--> statement-breakpoint
CREATE INDEX "idx_stay_service_posts_kind_service_date" ON "stay_service_posts" USING btree ("kind","service_date");--> statement-breakpoint
CREATE INDEX "idx_rate_plan_inventory_overrides_rate_plan_date" ON "rate_plan_inventory_overrides" USING btree ("rate_plan_id","date");--> statement-breakpoint
CREATE INDEX "idx_rate_plan_inventory_overrides_room_type_date" ON "rate_plan_inventory_overrides" USING btree ("room_type_id","date");--> statement-breakpoint
CREATE UNIQUE INDEX "uidx_rate_plan_inventory_overrides_unique" ON "rate_plan_inventory_overrides" USING btree ("rate_plan_id","room_type_id","date");--> statement-breakpoint
CREATE INDEX "idx_room_inventory_property_date" ON "room_inventory" USING btree ("property_id","date");--> statement-breakpoint
CREATE INDEX "idx_room_inventory_room_type_date" ON "room_inventory" USING btree ("room_type_id","date");--> statement-breakpoint
CREATE INDEX "idx_room_inventory_stop_sell_date" ON "room_inventory" USING btree ("stop_sell","date");--> statement-breakpoint
CREATE UNIQUE INDEX "uidx_room_inventory_room_type_date" ON "room_inventory" USING btree ("room_type_id","date");--> statement-breakpoint
CREATE INDEX "idx_room_type_rates_rate_plan_created" ON "room_type_rates" USING btree ("rate_plan_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_room_type_rates_room_type_created" ON "room_type_rates" USING btree ("room_type_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_room_type_rates_price_schedule_created" ON "room_type_rates" USING btree ("price_schedule_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_room_type_rates_active_created" ON "room_type_rates" USING btree ("active","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_stay_rules_property_priority_created" ON "stay_rules" USING btree ("property_id","priority","created_at");--> statement-breakpoint
CREATE INDEX "idx_stay_rules_rate_plan_priority_created" ON "stay_rules" USING btree ("rate_plan_id","priority","created_at");--> statement-breakpoint
CREATE INDEX "idx_stay_rules_room_type_priority_created" ON "stay_rules" USING btree ("room_type_id","priority","created_at");--> statement-breakpoint
CREATE INDEX "idx_stay_rules_active_priority_created" ON "stay_rules" USING btree ("active","priority","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_transaction_pii_access_log_parent" ON "transaction_pii_access_log" USING btree ("parent_id");--> statement-breakpoint
CREATE INDEX "idx_transaction_pii_access_log_participant" ON "transaction_pii_access_log" USING btree ("traveler_id");--> statement-breakpoint
CREATE INDEX "idx_transaction_pii_access_log_actor" ON "transaction_pii_access_log" USING btree ("actor_id");--> statement-breakpoint
CREATE INDEX "idx_transaction_pii_access_log_created_at" ON "transaction_pii_access_log" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_contact_assignments_offer_created" ON "offer_contact_assignments" USING btree ("offer_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_contact_assignments_item_created" ON "offer_contact_assignments" USING btree ("offer_item_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_contact_assignments_role_created" ON "offer_contact_assignments" USING btree ("offer_id","role","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_contact_assignments_person_created" ON "offer_contact_assignments" USING btree ("person_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_contact_assignments_order_created" ON "order_contact_assignments" USING btree ("order_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_contact_assignments_item_created" ON "order_contact_assignments" USING btree ("order_item_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_contact_assignments_role_created" ON "order_contact_assignments" USING btree ("order_id","role","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_contact_assignments_person_created" ON "order_contact_assignments" USING btree ("person_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_item_participants_item_created" ON "offer_item_participants" USING btree ("offer_item_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_item_participants_participant_created" ON "offer_item_participants" USING btree ("traveler_id","created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "uidx_offer_item_participants" ON "offer_item_participants" USING btree ("offer_item_id","traveler_id");--> statement-breakpoint
CREATE INDEX "idx_offer_items_offer_created" ON "offer_items" USING btree ("offer_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_items_product_created" ON "offer_items" USING btree ("product_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_items_option_created" ON "offer_items" USING btree ("option_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_items_unit_created" ON "offer_items" USING btree ("unit_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_items_slot_created" ON "offer_items" USING btree ("slot_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_items_status_created" ON "offer_items" USING btree ("status","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_participants_offer_created" ON "offer_participants" USING btree ("offer_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_participants_person_created" ON "offer_participants" USING btree ("person_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_participants_type" ON "offer_participants" USING btree ("participant_type");--> statement-breakpoint
CREATE INDEX "idx_offers_created" ON "offers" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "idx_offers_status_created" ON "offers" USING btree ("status","created_at");--> statement-breakpoint
CREATE INDEX "idx_offers_person_created" ON "offers" USING btree ("person_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offers_organization_created" ON "offers" USING btree ("organization_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offers_opportunity_created" ON "offers" USING btree ("opportunity_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offers_quote_created" ON "offers" USING btree ("quote_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offers_market_created" ON "offers" USING btree ("market_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_order_item_participants_item_created" ON "order_item_participants" USING btree ("order_item_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_item_participants_participant_created" ON "order_item_participants" USING btree ("traveler_id","created_at");--> statement-breakpoint
CREATE UNIQUE INDEX "uidx_order_item_participants" ON "order_item_participants" USING btree ("order_item_id","traveler_id");--> statement-breakpoint
CREATE INDEX "idx_order_items_order_created" ON "order_items" USING btree ("order_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_items_offer_item_created" ON "order_items" USING btree ("offer_item_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_items_product_created" ON "order_items" USING btree ("product_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_items_option_created" ON "order_items" USING btree ("option_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_items_unit_created" ON "order_items" USING btree ("unit_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_items_slot_created" ON "order_items" USING btree ("slot_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_items_status_created" ON "order_items" USING btree ("status","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_participants_order_created" ON "order_participants" USING btree ("order_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_participants_person_created" ON "order_participants" USING btree ("person_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_participants_type" ON "order_participants" USING btree ("participant_type");--> statement-breakpoint
CREATE INDEX "idx_order_terms_offer_sort" ON "order_terms" USING btree ("offer_id","sort_order","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_terms_order_sort" ON "order_terms" USING btree ("order_id","sort_order","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_terms_type_sort" ON "order_terms" USING btree ("term_type","sort_order","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_terms_acceptance_sort" ON "order_terms" USING btree ("acceptance_status","sort_order","created_at");--> statement-breakpoint
CREATE INDEX "idx_orders_created" ON "orders" USING btree ("created_at");--> statement-breakpoint
CREATE INDEX "idx_orders_offer_created" ON "orders" USING btree ("offer_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_orders_status_created" ON "orders" USING btree ("status","created_at");--> statement-breakpoint
CREATE INDEX "idx_orders_person_created" ON "orders" USING btree ("person_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_orders_organization_created" ON "orders" USING btree ("organization_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_orders_opportunity_created" ON "orders" USING btree ("opportunity_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_orders_quote_created" ON "orders" USING btree ("quote_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_orders_market_created" ON "orders" USING btree ("market_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_offer_staff_assignments_offer_created" ON "offer_staff_assignments" USING btree ("offer_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_staff_assignments_item_created" ON "offer_staff_assignments" USING btree ("offer_item_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_staff_assignments_role_created" ON "offer_staff_assignments" USING btree ("offer_id","role","created_at");--> statement-breakpoint
CREATE INDEX "idx_offer_staff_assignments_person_created" ON "offer_staff_assignments" USING btree ("person_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_staff_assignments_order_created" ON "order_staff_assignments" USING btree ("order_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_staff_assignments_item_created" ON "order_staff_assignments" USING btree ("order_item_id","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_staff_assignments_role_created" ON "order_staff_assignments" USING btree ("order_id","role","created_at");--> statement-breakpoint
CREATE INDEX "idx_order_staff_assignments_person_created" ON "order_staff_assignments" USING btree ("person_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_sellability_snapshots_status_updated" ON "sellability_snapshots" USING btree ("status","updated_at");--> statement-breakpoint
...
CREATE INDEX "idx_resources_active_created" ON "resources" USING btree ("active","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_suppliers_primary_facility_created" ON "suppliers" USING btree ("primary_facility_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_product_types_active_sort_name" ON "product_types" USING btree ("active","sort_order","name");--> statement-breakpoint
...
CREATE INDEX "idx_booking_staff_assignments_person" ON "booking_staff_assignments" USING btree ("person_id");--> statement-breakpoint
...
CREATE INDEX "idx_contracts_order_created" ON "contracts" USING btree ("order_id","created_at");--> statement-breakpoint
...
CREATE INDEX "idx_policy_acceptances_order_accepted" ON "policy_acceptances" USING btree ("order_id","accepted_at");--> statement-breakpoint
...
CREATE INDEX "catalog_overlay_origin_idx" ON "catalog_overlay" USING btree ("origin");--> statement-breakpoint
