...
function readBilling(travelerParty: Record<string, unknown>): BillingRecordValue | null {
...
function readTravelers(travelerParty: Record<string, unknown>): TripTravelerRecord[] {
...
function formatContactName(contact: BillingRecordValue["contact"]): string | null {
