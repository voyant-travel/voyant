CREATE TABLE "crm_organization_products_product" (
...
CREATE TABLE "crm_person_products_product" (
	"id" text PRIMARY KEY NOT NULL,
...
--> statement-breakpoint
CREATE TABLE "legal_contract_transactions_order" (
	"id" text PRIMARY KEY NOT NULL,
	"legal_contract_id" text NOT NULL,
...
--> statement-breakpoint
CREATE UNIQUE INDEX "crm_organization_products_product_pair_idx" ON "crm_organization_products_product" USING btree ("crm_organization_id","products_product_id") WHERE "deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX "crm_organization_products_product_l_idx" ON "crm_organization_products_product" USING btree ("crm_organization_id") WHERE "deleted_at" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "crm_organization_products_product_r_uniq" ON "crm_organization_products_product" USING btree ("products_product_id") WHERE "deleted_at" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "crm_person_products_product_pair_idx" ON "crm_person_products_product" USING btree ("crm_person_id","products_product_id") WHERE "deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX "crm_person_products_product_l_idx" ON "crm_person_products_product" USING btree ("crm_person_id") WHERE "deleted_at" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "crm_person_products_product_r_uniq" ON "crm_person_products_product" USING btree ("products_product_id") WHERE "deleted_at" IS NULL;--> statement-breakpoint
...
CREATE UNIQUE INDEX "legal_contract_transactions_order_pair_idx" ON "legal_contract_transactions_order" USING btree ("legal_contract_id","transactions_order_id") WHERE "deleted_at" IS NULL;--> statement-breakpoint
CREATE UNIQUE INDEX "legal_contract_transactions_order_l_uniq" ON "legal_contract_transactions_order" USING btree ("legal_contract_id") WHERE "deleted_at" IS NULL;--> statement-breakpoint
CREATE INDEX "legal_contract_transactions_order_r_idx" ON "legal_contract_transactions_order" USING btree ("transactions_order_id") WHERE "deleted_at" IS NULL;--> statement-breakpoint
...
CREATE INDEX "legal_policy_products_product_r_idx" ON "legal_policy_products_product" USING btree ("products_product_id") WHERE "deleted_at" IS NULL;